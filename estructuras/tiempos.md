...
|---|---|---|---|---|
| Backshift: presente dentro de marco pasado | 10 | 2026-09-20 | Detrás de un verbo en pasado, la subordinada retrocede. `is` → `was`, `there are` → `there were`. Aunque siga siendo verdad hoy. | El español NO retrocede: «resulta que el perfil **está** registrado». Si el marco va en pasado, el relleno también. |
...
| Presente por pasado en el hilo del relato | 4 | 2026-09-20 | Si el relato va en pasado, TODOS los verbos del hilo van en pasado simple, no solo el primero. | «me **contó**», «me **dijo**» — un pretérito en español es un pasado en inglés, siempre. |
...
| Present perfect por pasado simple (episodio cerrado) | 2 | 2026-09-20 | Episodio terminado y acotado → pasado simple. El present perfect solo si llega hasta AHORA. | «**Estuve** media hora…» — pretérito cerrado, ya no sigue pasando. |
| Auxiliar + verbo conjugado | 2 | 2026-09-20 | Detrás de `do/does/did/doesn't` va el verbo DESNUDO: `didn't make`, nunca `doesn't made`. | No hay disparador ES: el español conjuga el verbo principal y arrastra. Regla mecánica. |
...
| Pasado simple por participio (`have wrote`) | 1 | 2026-09-20 | Detrás de `have` va la 3ª forma (`written`), nunca la 2ª (`wrote`). Espejo del error `begun`. | «tendría que **HABER** + participio» — si el español lleva *haber*, el inglés lleva `have` + 3ª forma. |
